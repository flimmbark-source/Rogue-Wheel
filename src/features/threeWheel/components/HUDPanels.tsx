  ...
  const Panel = ({ side }: { side: LegacySide }) => {
    ...
    return (
      <div className="flex h-full flex-col items-center w-full">
        <div
          className="relative flex min-w-0 items-start sm:items-center gap-2 rounded-lg border px-2 py-2 sm:py-1 text-[12px] shadow w-full flex-wrap sm:flex-nowrap min-h-[60px] sm:min-h-0"
          style={{
            maxWidth: "100%",
